...
const SingleCar = () => {
    ...
    return (
        <div className='min-h-screen'>
            ...
            <div className='flex flex-col-reverse lg:flex-row justify-around mt-32'>
                ...
                <img className='w-full lg:w-5/12' src={car.photo} alt='' />
            </div>


            <div className='mb-40 flex flex-col-reverse lg:flex-row justify-around'>
                <div className='grid grid-cols-2 gap-20 bg-red-600 lg:w-5/12 h-96 lg:ml-32 mt-40 p-20'>
                    <div>
                ...
                <div className='h-97 lg:w-5/12 h-96 lg:mr-20 mt-48 m-5 lg:ml-20'>
                    <div className='mb-5 pr-3 py-0 border-r-8 border-red-600'>
                        <p className=' text-5xl font-bold text-left lg:text-right'>Details</p>
                    </div>
                    <p className='text-left lg:text-right'>{car.about}</p>
                </div>
