    ...
    return (
        <div className='bg1 h-screen'>
            <div className=' relative top-96'>
                <p className='text-5xl font-bold text-white outline py-5 pl-10 text-left'>We are the best when it comes to <br />Exotic Cars.<br/>Sell your luxury car in 29 minutes.</p>
